    ...
    <div className="min-h-screen bg-gray-900 p-4 md:p-8">
      <div className="max-w-7xl mx-auto mb-8">
        ...
        <p className="text-gray-400">
          Press{" "}
          <kbd className="px-2 py-1 bg-gray-700 rounded text-sm">Spacebar</kbd>{" "}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button
            className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg transition-all transform hover:scale-105 flex items-center gap-2 focus:outline-none"
          ...
          <button
            className="px-8 py-4 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold rounded-lg shadow-lg transition-all transform hover:scale-105 flex items-center gap-2 focus:outline-none"
            onClick={unlockAll}
          >
          ...
          <button
            className="px-8 py-4 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg shadow-lg transition-all transform hover:scale-105 flex items-center gap-2 relative focus:outline-none"
